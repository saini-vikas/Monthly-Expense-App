...
function App() {
  ...
  return (
    <div className="app-container">
      ...
      <AddContainer screenWidth={screenWidth} onAddExpense={fetchDataFromDatabase} expenseToEdit={editExpenseContent} expenses={data} selectYear={selectYear} />
      <ExpenseDetail screenWidth={screenWidth} onEditExpense={editExpense} onAddExpense={fetchDataFromDatabase} expenses={data} selectYear={selectYear}/>
    </div>
  );
}
